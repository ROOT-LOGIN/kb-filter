...
#define DebugPrintEx(format, ...) \
	DbgPrintEx(DPFLTR_IHVDRIVER_ID, 0xFF000000, format, __VA_ARGS__)
#else   // DBG
...
typedef union _MODIFYKEY_STATE{
	struct {
		LRPAIR Shift;
		LRPAIR Control;
		LRPAIR Alt;
...
extern MODIFYKEY_STATE g_ModifykeyState;
